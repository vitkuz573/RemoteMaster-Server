...
export default function DeviceByIdRewrittenPage() {
  const p = useParams<{ id: string[] }>();
  const parts = (p?.id || []) as unknown as string[];
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 p-4">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">Connected to (Internet ID)</div>
