...
const ClientEnvSchema = z.object({
  ...
  // Optional client-configurable endpoints list. JSON array string or compact CSV.
  // Example JSON: \n//   [ { "name":"API","url":"https://...","method":"HEAD" }, { "name":"Health","url":"...","method":"GET" } ]\n// Example CSV: \n//   API|https://...|HEAD,Health|https://...|GET
  NEXT_PUBLIC_ENDPOINTS: z.string().optional(),
  ...
  NEXT_PUBLIC_SENTRY_DSN: z.union([z.string().url(), z.literal('')]).optional().default(''),
...
const raw = {
  ...
  NEXT_PUBLIC_ENDPOINTS: process.env.NEXT_PUBLIC_ENDPOINTS,
